...
@section('title', 'Detail Arsip Dokumen Sertijab')
            ...
            <div class="header-left">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('arsip.search') }}">Pencarian</a>
                        </li>
            ...
            <div class="detail-card">
                ...
                <div class="card-body">
                    <div class="quick-actions">
                        ...
                        <a href="{{ route('arsip.search', ['kapal_id' => $arsip->mutasi->id_kapal]) }}" 
                           class="action-btn btn-outline-primary">
                            <i class="bi bi-ship"></i>
                            <span>Arsip Kapal Ini</span>
                        </a>
